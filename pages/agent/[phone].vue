<template>
  <div class=" bg-stone-50 dark:bg-stone-950 transition-colors duration-300">
    <div class="relative z-10 flex flex-col  text-balance">
      ...
      <!-- Invite Agent Modal -->
      <Teleport to="body">
        <div v-if="showInviteModal" class="fixed inset-0 w-screen h-screen bg-stone-900/20 backdrop-blur-sm grid place-items-center z-[999] p-6 overflow-y-auto">
          <div class="bg-white dark:bg-stone-900 rounded-xl p-8 max-w-md w-full animate-bounce-in shadow-xl border border-stone-200 dark:border-stone-800">
            <div class="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 class="font-bold text-stone-900 dark:text-white">Invite Agent</h3>
            ...
            <div class="space-y-4">
               <!-- Agent Number -->
               <div class="p-3 bg-stone-50 dark:bg-stone-800 rounded-lg border border-stone-100 dark:border-stone-700">
                 <p class="text-[10px] font-bold text-stone-400 uppercase tracking-widest mb-1">Agent's Number</p>
                 <p class="text-lg font-mono font-bold text-stone-900 dark:text-white">{{ formattedPhone }}</p>
               </div>
               ...
               <div>
                 ...
                 <input
                   ...
                   class="w-full px-4 py-3 bg-white dark:bg-stone-950 border border-stone-200 dark:border-stone-700 rounded-lg text-sm font-medium text-stone-900 dark:text-white focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all placeholder-stone-300"
                 />
               </div>
               ...
               <div>
                 ...
                 <div class="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg text-xs text-blue-800 dark:text-blue-300 font-mono whitespace-pre-wrap border border-blue-100 dark:border-blue-800/30">{{ inviteSmsMessage }}</div>
               </div>
               ...
               <div class="flex gap-3 pt-2">
                 <button
                   ...
                   class="flex-1 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 text-sm"
                 >
                 ...
                 <button
                   ...
                   class="px-5 py-3 bg-white border border-stone-200 text-stone-600 font-medium rounded-lg hover:bg-stone-50 transition-colors text-sm"
                 >
                   Cancel
                 </button>
               </div>
