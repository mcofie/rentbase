...
create table rentbase.reviews (
  ...
  reviewer_phone text, -- For anonymous reviews
  ip_address text, -- Spam prevention
...
-- ============================================
-- 6. AGENT INVITATIONS (SMS Invites Tracking)
-- ============================================
create table rentbase.agent_invitations (
  id uuid default gen_random_uuid() primary key,
  agent_phone text not null,
  inviter_name text,
  status text default 'sent' check (status in ('sent', 'registered', 'expired')),
  sent_at timestamptz default now(),
  registered_at timestamptz
);

-- Index for tracking invitations by agent phone
create index idx_agent_invitations_phone on rentbase.agent_invitations (agent_phone);
