<template>
  <div class="sms-sender">
    ...
    <!-- Modal -->
    <div v-if="showModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-6">
      <div class="bg-white dark:bg-stone-900 rounded-[24px] p-6 max-w-md w-full animate-bounce-in">
        <!-- Header -->
        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2">
            <div class="flex items-center gap-2 px-4 py-3 bg-stone-50 dark:bg-stone-800 rounded-xl">
        ...
        <div class="mb-6">
          ...
          <div class="p-4 bg-stone-50 dark:bg-stone-800 rounded-xl text-sm text-stone-600 dark:text-stone-300 font-mono whitespace-pre-wrap max-h-32 overflow-y-auto">
            {{ messagePreview }}
          </div>
